...
def jugar():
    #Globalizamos todas las variables necesarias en esta funcion.    
    global nave, fondo, aceleracion, velocidad, angulo,pantalla, chose_token, ficha, j, nivel, count, puntos, pos_ficha_x, pos_ficha_y
    ...
    if nivel == 1:
        ...
        i = randint(1, 3)
        pos_ficha_x = randint(150, 230)
        pos_ficha_y = randint(270, 520)
        ...
        pantalla.create_image(pos_ficha_x, pos_ficha_y, anchor=NW, image=ficha, tags='token')
...
def test():
    #Globalizamos todas las variables necesarias en esta funcion.
    global nave, fondo, vidas, aceleracion, chose_token, velocidad, angulo, nivel, j, ficha, deltaA, puntos, pos_ficha_x, pos_ficha_y
    if nivel == 1:
        ...
        ficha1 = pantalla.find_overlapping(pos_ficha_x, pos_ficha_y, pos_ficha_x+30, pos_ficha_x+30)
        tl1 = lado1.__len__()
        tl2 = lado2.__len__()
        tm = meta.__len__()
        tf1 = ficha1.__len__()
